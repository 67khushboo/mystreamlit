...
st.set_page_config(page_title='tutorial.pyStreamlit',page_icon='random')#shark/random
...
if(mymenu=='Home'):
    ...
    st.header("Downloads")
    st.download_button('Download Now','hello this is the downloade data','onlei.txt')
